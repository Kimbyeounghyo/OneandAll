...
public class P_Project implements Externalizable{
	...
	public List<CPT_Coworker> workers; //프로젝트 참여자
	...
	public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
		...
		workers = (List<CPT_Coworker>)in.readObject();
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof P_Project) {
			P_Project p = (P_Project)obj;

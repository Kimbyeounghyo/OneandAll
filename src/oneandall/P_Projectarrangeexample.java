...
public class P_Projectarrangeexample extends JFrame{
	
	
	public P_Projectarrangeexample() {
...
//	         teamname.setOpaque(true);
	         ...
	         UI_PinkButtonTeamName pb=new UI_PinkButtonTeamName(new Color(255, 235, 235), new Color(255,255,255));
	         /*JButton(){
...
//	         pb.setBounds(10, 300, 300, 300);
	         ...
	         //스크롤
	         JScrollPane scroll = new UI_PinkScroll(pan) {
	        	 @Override
	        	 public void setBorder(Border border) {
	        	 }

...
public class UI_PinkRoundIconButton extends JButton {
	
	Color buttonColor;
	File imageFile;

	public UI_PinkRoundIconButton() {
		setBorderPainted(false);
		setOpaque(false);
		
		buttonColor = new Color(255, 198, 218);
	}
	public UI_PinkRoundIconButton(String text) {
		setBorderPainted(false);
		setOpaque(false);
	...
	public UI_PinkRoundIconButton(File f) {
		setBorderPainted(false);
		setOpaque(false);

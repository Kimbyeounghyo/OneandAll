...
public class ProjectManagementPanel extends JPanel {
	...
	public ProjectManagementPanel(Project p) {
		...
		System.out.println(LoginInfo.getLoggedInfo().grade);
		handPersonName.setText(LoginInfo.getLoggedInfo().name);

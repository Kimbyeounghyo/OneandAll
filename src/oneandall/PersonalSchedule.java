...
//            }
   ...
   public void weekSch(String sat1,String sat2, String sun1,String sun2) {
      ...
      for(int i=0;i<=3;i++) {
         p_bar_G=new PinkButton(sat1);
         p_bar_R=new GreenButton(sat2);
      ...
      for(int i=0;i<=3;i++) {
         p_bar_G=new PinkButton(sun1);
         p_bar_R=new GreenButton(sun2);
   ...
   public void weekSch(String sat, String sun){
      for(int i=0;i<=3;i++) {
         p_bar_G=new PinkButton(sat);
         Label_Day[6+7*i].add(p_bar_G);
         p_bar_G.setBounds(14,12,70,12);
      }
      for(int i=0;i<=3;i++) {
         p_bar_G=new GreenButton(sun);
         Label_Day[7+7*i].add(p_bar_G);
         p_bar_G.setBounds(14,12,70,12);
      }
   }

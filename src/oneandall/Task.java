...
public class Task implements Externalizable{
	...
	public Coworker worker; //회원 이름 @ 태그
	...
	public Task(String projectName, String content, Coworker worker, String startDate, String endDate,
			long priorTaskIds) {
